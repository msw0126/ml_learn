...
if __name__ == "__main__":
    ...
    # print 'c = ', c
    # # #
    # # 和linspace（等差数列）类似，logspace（等比数列）可以创建等比数列
    ...
    # # logspace创建等比数列。下面函数创建起始值为10^0，终止值为10^9
    ...
    # print a
    # # 二维数组的切片
    # print a[(0,1,2,3), (2,3,4,5)]  # M行的第N个元素（第0行的第2个元素）
    # print a[3:, [0, 2, 5]]
    ...
    # # 文档：https://blog.csdn.net/u014539580/article/details/78207537
    # plt.plot(x, y, 'r--', linewidth=2)
    # plt.title(u'Sin曲线')
    # # 设置轴记号,下面时使x轴旋转
